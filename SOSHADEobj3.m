...
%%%%%%%%%%%%%%%%%%% 
function shade(fun,foutput,nloop,nsol,nvar,nbit,a,b)
...
for i=1:size(pop,1)
    fitness(i) = feval(fhd,pop(i,:)',1e20);
end
fitness = fitness';
...
%     cr = normrnd(mu_cr, 0.1);
    ...
    children_fitness=[];
    for i=1:size(ui,1)
        children_fitness(i) = feval(fhd, ui(i,:)',fitness(i));
    end
...
maxeval=nloop*nsol;
save(foutput,'xmin','fpmin','fmin','gmin','maxeval','time')
