...
% load(fundat);
% popold=x0';
[valParents,f0,g0] = objeval(popold,fun,1e20*ones(popsize,1));
...
while FES < nloop*nsol %& min(fit)>error_value(problem)
    ...
    [valOffspring,f1,g1] = objeval(ui,fun,valParents);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [fp,f,g] = objeval(popold,fun,fp0);
for i=1:size(popold,1)
    [fp(i,1),f(i),g(:,i)]=feval(fun,popold(i,:)',fp0(i));
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
