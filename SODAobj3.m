...
function SODA(fun,foutput,nloop,nsol,nvar,nbit,a,b)
...
Fitness=1e20*ones(1,SearchAgents_no);
...
for iter=1:Max_iteration
    ...
    for i=1:SearchAgents_no %Calculate all the objective values first
        [Fitness(1,i),obj(1,i),const(:,i)]=feval(fun,X(:,i),Fitness(i));
